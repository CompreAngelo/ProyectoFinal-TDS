        ...
        <nav className={`sidebar ${isOpen ? "active" : ""}`}>
          <ul>
            ...
            <div className="MenuList">
              <li
                style={{ "--bg": "#6bfaa4" }}
                className={activeMenuItem === "home-agente" ? "active" : ""}
              >
                <a
                  href="/home-agente"
                  onClick={(e) => handleLinkClick(e, "home-agente")}
                >
                  <div className="icon2">
            ...
            <div className="MenuList">
              ...
              >
                <a
                  ...
                  onClick={(e) => handleLinkClick(e, "nuevamulta")}
                >
                  <p className="uppercase">Nuevas Multas</p>
                </a>
              </li>
              <li
                style={{ "--bg": "#4d0000" }}
              ...
              >
                ...
                >
                  <p className="uppercase">Historial</p>
                </a>
              </li>
            </div>
            <div className="bottom">
